...
function PackageSignerReady_OSS() {
    ...
    for (i = 0; i < signerList_OSS.length; i++) {
        ...
        // newSigner += '<div id="divSignerRow' + i + '_OSS" signerNumber="' + i + '" class="row padding-bottom-oss signer-row-oss">';
        // newSigner += '	<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">';
        ...
        // newSigner += '          <span id="' + signerList_OSS[i].firstName + '" name="' + signerList_OSS[i].firstName + '"  signerNumber="' + i + '" signerInfo="FirstName" ">'+signerList_OSS[i].firstName+'</span>';
        ...
        newSigner += '<div class="doc-item-wrapper-oss signer-item-wrapper-oss" style="width:850px;padding-right:10px;">';
        newSigner += '    <div class="doc-item-file-blank-oss" style="padding-top:17px;"><span class="ossicon-user-oss"></div>';
        newSigner += '    <div class="doc-item-file-blank-oss" style="width: 270px; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;padding-top:18px;">' + signerList_OSS[i].name + '</div>';
        newSigner += '    <div class="doc-item-file-blank-oss" style="width: 270px; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;padding-top:18px;">' + signerList_OSS[i].email + '</div>';
        newSigner += '  <div style="float: right;padding-top:8px;">';
        if(signerList_OSS[i].hasComplete) {
            newSigner += '    <div class="doc-item-file-blank-oss" style="width:60px;padding-top:8px;"><span style=" margin-right:15px;margin-left:3px;" class="ossicon-tokenComplete-oss" data="' + signerList_OSS[i].email + '" role="signer"></div>';
        }else{
            newSigner += '    <div class="doc-item-file-blank-oss waves-effect " style="width:30px;margin-right:37px;padding-top:8px;"><span style=" cursor: pointer;margin-right:15px;" class="ossicon-sendToken-oss gen-token-twilio " data="' + signerList_OSS[i].email + '" role="signer" signer="'+signerList_OSS[i].name+'"></div>';
        }
        // or token complete    ossicon-tokenComplete-oss
        // newSigner += '    <div class="doc-item-file-blank-oss"><span style=" cursor: pointer;"  class="ossicon-user-oss gen-token-twilio" data="' + signerList_OSS[i].email + '" role="notary"></div>';
        // newSigner += '   <button type="button" class=" gen-token-twilio align-center-oss waves-effect" data="' + signerList_OSS[i].email + '" role="notary"  signer="'+signerList_OSS[i].name+'">GO TO ROOM</button>';
        newSigner += '   <a   class="btn btn-primary gen-token-twilio  waves-effect"  style="display:block;margin:auto;background-color: #2f94d0!important;height:43px;"  data="' + signerList_OSS[i].email + '" role="notary"  signer="'+signerList_OSS[i].name+'">Go to Room</a>';
        newSigner += '  </div>';
        newSigner += '</div>';
    ...
    //add notary
    var notary = '';
    notary += '<div class="doc-item-wrapper-oss signer-item-wrapper-oss" style="width:850px;padding-right:10px;">';
    notary += '    <div class="doc-item-file-blank-oss" style="padding-top:17px;"><span class="ossicon-notary-oss"></div>';
    notary += '    <div class="doc-item-file-blank-oss" style="width: 270px; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;padding-top:18px;">' + sender.name + '</div>';
    notary += '    <div class="doc-item-file-blank-oss" style="width: 270px; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;padding-top:18px;">' + sender.email + '</div>';
    notary += '  <div style="float: right;padding-top: 8px;">';
    // notary += '    <div class="doc-item-file-blank-oss"><span class="ossicon-notary-oss go-notary-sign" data="' + sender.email + '" role="notary"></div>';
    // notary += '   <div ><button type="button" class="go-notary-sign align-center-oss waves-effect" data="' + sender.email + '" role="notary">NOTARY SIGN</button></div>';
    notary += '   <a   class="btn btn-primary go-notary-sign  waves-effect"  style="display:block;margin:auto;background-color: #2f94d0!important;height:43px;"  data="' + sender.email + '" role="notary">Notary Sign</a>';

    notary += '  </div>';
    notary += '</div>';
    $("#divSigners_OSS").append(notary);
    // RegisterSigner_OSS();
    //
    // newSignerNumber_OSS++;
    // });
