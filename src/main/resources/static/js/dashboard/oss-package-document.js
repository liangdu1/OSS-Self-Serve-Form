...
function GenerateDocumentList_OSS() {
    ...
    for (i = 0; i < documentList_OSS.length; i++) {
        ...
        htmlDocumentList += '        <div documentId="' + documentList_OSS[i].id + '" pageNum="'+documentList_OSS[i].pageNum+'"  documentName="'+documentList_OSS[i].name +'" class="ossicon-preview-oss"></div>';
    ...
    $(".doc-item-wrapper-oss").hover(function () {
        ...
        $(this).find("div.ossicon-preview-oss").css("display", "inline-block");
        ...
        $(this).find("div.ossicon-preview-oss").css("display", "none");
